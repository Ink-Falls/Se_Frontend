    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const [teachersRes, learnerGroupsRes, studentTeacherGroupsRes] = await Promise.all([
                    fetch(`${process.env.REACT_APP_API_URL}/users?role=teacher`, { headers }),
                    fetch(`${process.env.REACT_APP_API_URL}/groups?type=learner`, { headers }),
                    fetch(`${process.env.REACT_APP_API_URL}/groups?type=student_teacher`, { headers })
                ]);
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => setFormData({...formData, learner_group_id: e.target.value})}
                                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                            >
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => setFormData({...formData, student_teacher_group_id: e.target.value})}
                                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                            >
