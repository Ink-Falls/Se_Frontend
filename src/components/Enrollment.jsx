        ...
        <div className="flex items-center justify-center min-h-screen">
          ...
          <div className="mt-[-15vw] sm:mt-[5vw] lg:mt-[-10vw] flex flex-col lg:flex-row items-center rounded-lg gap-[5vw]">
            ...
            <div className="p-[5vw] w-[80vw] lg:h-[13.5vw] lg:mt-[-1vw] lg:p-[2vw] lg:w-[30vw] bg-white rounded-lg shadow-2xl relative">
              ...
              {/* Section header */}
              <h2 className="text-[8vw] lg:text-[2vw] font-bold text-left text-[#212529]">New Enrollee?</h2>
            ...
            <div className="p-[5vw] w-[80vw] lg:p-[2vw] lg:w-[30vw] bg-white rounded-lg shadow-2xl relative">
              ...
              {/* Section header */}
              <h2 className="text-[8vw] lg:text-[2vw] font-bold text-left text-[#212529]">Enrollment Status Tracker</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-[2vw]">
                ...
                <div className="flex justify-between items-center w-full">
                  ...
                  <div className="flex flex-row items-start ml-[2vw]">
                    {/* Status label */}
                    <h2 className="text-[3.5vw] mr-[2vw] mt-[2.5vw] mb-[1vw] lg:text-[1vw] lg:mr-[0.5vw] lg:mt-[1vw] font-bold text-left text-[#212529]">Status:</h2>
