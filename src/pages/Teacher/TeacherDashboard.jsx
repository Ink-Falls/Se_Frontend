  ...
  useEffect(() => {
    const fetchCourses = async () => {
      ...
      try {
        ...
        // Get the number of learners in each course
        for (const course of coursesData) {
          const groupMembers = await getGroupMembers(course.learner_group_id); 
          course.studentCount = groupMembers.length; 
        }
                    ...
                    <div className="mt-auto pt-4 border-t border-gray-100">
                      <div className="flex justify-start items-center text-sm text-gray-600">
                        <span className="flex items-center">
                          ...
                          {course.studentCount} {course.studentCount === 1 ? 'Learner' : 'Learners'}
                        </span>
                      </div>
                    </div>
                  </div>
