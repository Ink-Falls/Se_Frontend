...
const PublicPages = {
  ...
  VerifyMagicLink: lazy(() => import("./pages/General/VerifyMagicLink")),
...
const MaintenanceMode = lazy(() =>
  import("./pages/Maintenance/MaintenanceMode")
);
                ...
                element={
                  <RoleBasedRoute allowedRoles={["teacher", "student_teacher"]}>
                    <Routes>
                      <Route
                        path="Dashboard"
                        element={<TeacherPages.Dashboard />}
                      />
                      <Route
                        path="Notifications"
                        element={<TeacherPages.Notifications />}
                      />
                      <Route
                        path="NotificationDetails/:id"
                        element={<TeacherPages.NotificationDetails />}
                      />
                      <Route
                        path="CourseAnnouncements"
                        element={<TeacherPages.CourseAnnouncements />}
                      />
                      <Route
                        path="AnnouncementDetails/:id"
                        element={<TeacherPages.AnnouncementDetails />}
                      />
                      <Route
                        path="CourseModules"
                        element={<TeacherPages.CourseModules />}
                      />
                      <Route
                        path="Assessment"
                        element={<TeacherPages.CourseAssessment />}
                      />
                      <Route
                        path="Assessment/View/:id"
                        element={<TeacherPages.AssessmentView />}
                      />
                      <Route
                ...
                element={
                  <RoleBasedRoute allowedRoles={["learner"]}>
                    <Routes>
                      <Route
                        path="Dashboard"
                        element={<LearnerPages.Dashboard />}
                      />
                      <Route
                        path="Assessment"
                        element={<LearnerPages.CourseAssessment />}
                      />
                      <Route
                        path="CourseAnnouncements"
                        element={<LearnerPages.CourseAnnouncements />}
                      />
                      <Route
                        path="AnnouncementDetails/:id"
                        element={<LearnerPages.AnnouncementDetails />}
                      />
                      <Route
                        path="Notifications"
                        element={<LearnerPages.Notifications />}
                      />
                      <Route
                        path="NotificationDetails/:id"
                        element={<LearnerPages.NotificationDetails />}
                      />
                      <Route
                        path="CourseModules"
                        element={<LearnerPages.CourseModules />}
                      />
                      <Route
                        path="Assessment/:id"
                        element={<LearnerPages.CourseAssessment />}
